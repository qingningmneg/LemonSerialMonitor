...
The current version is `0.1.1` and is licensed under [MIT](LICENSE). Personal use, commercial use (including for-profit use and sale), modification, redistribution, and sublicensing are permitted. If you distribute copies or substantial portions of the software, you must retain `Copyright (c) 2026 qingningmneg` and the MIT permission notice.
